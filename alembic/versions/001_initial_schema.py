...
def upgrade() -> None:
    ...
    op.create_table('tasks',
        ...
        sa.Column('status', sa.Enum('PENDING', 'DOWNLOADING', 'COMPLETED', 'FAILED', 'RETRYING', 'CANCELLED', name='taskstatus'), nullable=False),
    ...
    op.create_table('proxies',
        ...
        sa.Column('status', sa.Enum('ACTIVE', 'FAILED', 'DISABLED', name='proxystatus'), nullable=False),
